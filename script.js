const randomColor0 = '#' + ((1 << 24) * Math.random()|0).toString(16);
...
function hexToRgb(randomColor4) {
  let result = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(randomColor4);
  return result ? {
...
function corInicial() {
  const showColor = document.getElementById('rgb-color');
